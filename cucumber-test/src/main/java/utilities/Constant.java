...
class Constant {
    ...
    final static String CONFIG_PROPERTIES_DIRECTORY = System.getProperty("user.dir") + "src" + File.pathSeparatorChar + "main"  + File.pathSeparatorChar + "resources"  + File.pathSeparatorChar + "config.properties";
